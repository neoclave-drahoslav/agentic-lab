...
GitHub Copilot reads repository-wide custom instructions from .github/copilot-instructions.md. It receives the same canonical agent roster, policies, domains, and project-generation rules as every other tool.
